...
function struve_h(v, x: double): double;
  {-Return H_v(x), the Struve function of order nu >= 0, x < 0 only if nu is an integer.}
...
function struve_l(v, x: double): double;
  {-Return L_v(x), the modified Struve function of order nu >= 0, x < 0 only if nu is an integer.}
