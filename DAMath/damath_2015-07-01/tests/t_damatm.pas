{T_DAMATM - regression test main unit for DAMATH  (c) 2013  W.Ehrhardt}
...
const
  ...
  TData: array[1..NT] of TPair = (
           (tx:  0;          ty:  0                         ),
           (tx:  1e-10;      ty:  0.3333333333333333333e-10 ),
           (tx:  1/1024;     ty:  0.3255208126372779994e-3  ),
           (tx:  0.25;       ty:  0.8298816507359656826e-1  ),
           (tx:  0.5+1/1024; ty:  0.1642632531019772181     ),
           (tx:  1-1/1024;   ty:  0.3127657674731261456     ),
           (tx:  1;          ty:  0.3130352854993313036     ),
           (tx:  1.125;      ty:  0.3467452117192722997     ),
           (tx:  2;          ty:  0.5373147207275480959     ),
           (tx:  2.5;        ty:  0.6135673098126084622     ),
           (tx:  10;         ty:  0.9000000041223072534     ),
           (tx:  23;         ty:  0.956521739130434783      ),
           (tx:  25;         ty:  0.96                      )
         );
const
  name = 'langevin';
...
begin
  total_cnt    := 0;
  total_failed := 0;
  writeln('T_DAMATH - main test program for DAMATH unit V',DAMath_Version,'   (c) 2009-2015  W.Ehrhardt');
