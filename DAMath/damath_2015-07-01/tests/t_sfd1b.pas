{Part 1b of regression test for SPECFUND unit  (c) 2010-2013  W.Ehrhardt}
...
begin
  ...
  testrel(46, NEx, y, f, cnt,failed);

  y := igamma(5000,55000);
  f := 8.278720754962823876E-190;
  testrel(47, NEx, y, f, cnt,failed);

  y := igamma(1700,16500);
  f := 0.4936956875959810692;
  testrel(48, NEx, y, f, cnt,failed);
