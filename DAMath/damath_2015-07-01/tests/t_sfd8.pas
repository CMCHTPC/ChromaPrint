{Part 8 of regression test for SPECFUND unit  (c) 2012-2013  W.Ehrhardt}
...
begin
  ...
  testrel(35, NE2, y, f, cnt,failed);   {For SSE NE1 is OK}
...
begin
  ...
  testrel(28, NE2, y, f, cnt,failed);   {!!64-bit}

  y := fermi_dirac(200,100);
  f := 0.2688117141816135437e44;
  testrel(29, NE2, y, f, cnt,failed);   {!!64-bit}
