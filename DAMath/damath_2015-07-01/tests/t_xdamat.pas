...
{$ifdef UNIT_SCOPE}
  ...
  begin
    z := x;
    {Delphi uses intpower(extended(1.0 + x), n)}
    z := system.math.intpower(extended(z+1.0), round(n));
    xcompound := z;
  end;
{$else}
 ...
 var
   z: extended;
 begin
   {Delphi uses intpower(1.0 + x, n)}
   z := x;
   z := math.intpower(z+1.0, round(n));
   xcompound := z;
 end;
 {$endif}
...
begin
  ...
  testfun('DAMath.cot',{$ifdef FPC_ProcVar}@{$endif}cot, {$ifdef FPC_ProcVar}@{$endif}mpf_cot, 1e-10, 1e10);
  testfun('DAMath.cot',{$ifdef FPC_ProcVar}@{$endif}cot, {$ifdef FPC_ProcVar}@{$endif}mpf_cot, 1e10, 5e18);;
{$ifdef FPCMATH}
...
begin
  ...
  testfun('DAMath.csc',{$ifdef FPC_ProcVar}@{$endif}csc, {$ifdef FPC_ProcVar}@{$endif}mpf_csc, 1e-10,1e10);
{$ifdef FPCMATH}
...
begin
  ...
  testfun('DAMath.sec',{$ifdef FPC_ProcVar}@{$endif}sec, {$ifdef FPC_ProcVar}@{$endif}mpf_sec, 0, 1e10);
{$ifdef FPCMATH}
...
begin
  ...
  testfun('DAMath.tan',{$ifdef FPC_ProcVar}@{$endif}tan, {$ifdef FPC_ProcVar}@{$endif}mpf_tan, 0, 1e10);
  testfun('DAMath.tan',{$ifdef FPC_ProcVar}@{$endif}tan, {$ifdef FPC_ProcVar}@{$endif}mpf_tan, 1e10, 5e18);;
{$ifdef USE_MATH}
...
begin
  ...
  testfun('DAMath.cos',{$ifdef FPC_ProcVar}@{$endif}DAMath.cos, {$ifdef FPC_ProcVar}@{$endif}mpf_cos, 0, 1e10);
  testfun('DAMath.cos',{$ifdef FPC_ProcVar}@{$endif}DAMath.cos, {$ifdef FPC_ProcVar}@{$endif}mpf_cos,1e10,5e18);
{$ifndef DAMOnly}
  ...
  testfun('system.cos',{$ifdef FPC_ProcVar}@{$endif}xcos, {$ifdef FPC_ProcVar}@{$endif}mpf_cos,1e10,5e18);;
{$endif}
end;
...
begin
  ...
  testfun('DAMath.sin',{$ifdef FPC_ProcVar}@{$endif}DAMath.sin, {$ifdef FPC_ProcVar}@{$endif}mpf_sin, 0, 1e10);
  testfun('DAMath.sin',{$ifdef FPC_ProcVar}@{$endif}DAMath.sin, {$ifdef FPC_ProcVar}@{$endif}mpf_sin,1e10,5e18);
{$ifndef DAMOnly}
  ...
  testfun('system.sin',{$ifdef FPC_ProcVar}@{$endif}xsin, {$ifdef FPC_ProcVar}@{$endif}mpf_sin,1e10,5e18);
{$endif}
end;
...
begin
  sep_line;
  testfun('DAMath.langevin',{$ifdef FPC_ProcVar}@{$endif}langevin, {$ifdef FPC_ProcVar}@{$endif}mpf_langevin, -1, 1);
  testfun('DAMath.langevin',{$ifdef FPC_ProcVar}@{$endif}langevin, {$ifdef FPC_ProcVar}@{$endif}mpf_langevin, -25, -1);
end;
...
begin
  ...
  writeln('Test DAMath V', DAMath_Version,' with MP_Arith V', MP_VERSION, '   (c) 2013-2015 W.Ehrhardt');
